...
mixture_file_all = read.delim("BRCA_mRNA_HiSeqV2.txt", header=T, row.names=1)
...
mir_df_all = read.delim("BRCA_miRNA_HiSeq_gene_t.txt", header=TRUE, row.names = 1)
...
# export subset files
write.table(mixture_subset_df, "BRCA_mRNA_mixture_subset.txt", sep="\t", row.names = TRUE, col.names = TRUE)
write.table(mir_subset_df, "BRCA_miR_mixture_subset.txt", sep="\t", row.names = TRUE, col.names = TRUE)
...
cibersort.df = read.delim("BRCA_mRNA_CIBERSORT-Results.txt", header=TRUE)
...
write.table(A.matrix, "BRCA_A.matrix.txt", sep="\t", row.names = TRUE, col.names = TRUE)
write.table(B.matrix, "BRCA_B.matrix.txt", sep="\t", row.names = TRUE, col.names = TRUE)
...
write.table(signature_matrix, "BRCA_signature_matrix_unconstrained.txt", sep="\t", row.names = TRUE, col.names = TRUE)
...
write.table(signature_matrix_nonnegative, "BRCA_signature_matrix_nonnegative.txt", sep="\t", row.names = TRUE, col.names = TRUE)
write.table(t_sig_matrix_nonneg, "BRCA_signature_matrix_nonnegative_t.txt", sep="\t", row.names = TRUE, col.names = TRUE)
...
write.table(T.full.probability.results, "BRCA_pnorm_results.txt", sep="\t", row.names = TRUE, col.names = TRUE)
...
for (i in 1:dim(T.full.probability.results)[2]){
  ...
  filename = paste("20180531_BRCA_", "ranked_", i, ".txt", sep="")
...
write.table(ordered.cond.num.results, "BRCA_ordered.cond.num.results.txt", sep="\t", row.names = TRUE, col.names = TRUE)
...
write.table(final.subset.sig.df, "BRCA_final.sig.matrix.txt", sep="\t", row.names = TRUE, col.names = TRUE)
...
CIBERSORT <- function(sig_matrix, mixture_file, perm=0, QN=TRUE){
  ...
  #save results
  write.table(rbind(header,output), file="BRCA_miRNA_CIBERSORT-Results.txt", sep="\t", row.names=F, col.names=F, quote=F)
...
results_BRCA_miRNA <- CIBERSORT(mir_sig_matrix, mir_mixture_file, perm=0, QN=FALSE)
...
CIBERSORT <- function(sig_matrix, mixture_file, perm=0, QN=TRUE){
  ...
  #save results
  write.table(rbind(header,output), file="BRCA_combined_CIBERSORT-Results.txt", sep="\t", row.names=F, col.names=F, quote=F)
...
combined_BRCA.results <- CIBERSORT(combined.sig.matrix, merged.mixture.file, perm=0, QN=FALSE)
...
CIBERSORT <- function(sig_matrix, mixture_file, perm=0, QN=TRUE, absolute=FALSE, abs_method='sig.score'){
  ...
  #save results
  write.table(rbind(header,output), file="BRCA_survival_mRNA_CIBERSORT-Results.txt", sep="\t", row.names=F, col.names=F, quote=F)
...
survival_df = read.delim("xena_BRCA_survival.txt", header=T)

# import deconvolution results
cibersort_df = read.delim("BRCA_survival_mRNA_CIBERSORT-Results.txt", header=T)
...
write.table(coxph_results_table_names, "BRCA_mRNA_univariate_coxph_results.txt", sep="\t", row.names = FALSE, col.names = TRUE)

# miRNA UNIVARIATE SURVIVAL ANALYSIS #

# import deconvolution results
cibersort_df = read.delim("BRCA_miRNA_CIBERSORT-Results.txt", header=T)
colnames(cibersort_df)[1] = c("ID")
cibersort_df$ID = as.character(cibersort_df$ID)
cibersort_df$ID = gsub("[.]","",cibersort_df$ID)
...
write.table(coxph_results_table_names, "BRCA_miRNA_univariate_coxph_results.txt", sep="\t", row.names = FALSE, col.names = TRUE)

# mRNA-miRNA UNIVARIATESURVIVAL ANALYSIS #

# import deconvolution results
cibersort_df = read.delim("BRCA_combined_CIBERSORT-Results.txt", header=T)
cibersort_df$ID = as.character(cibersort_df$ID)
cibersort_df$ID = gsub("[.]","",cibersort_df$ID)
...
write.table(coxph_results_table_names, "BRCA_combined_univariate_coxph_results.txt", sep="\t", row.names = FALSE, col.names = TRUE)
